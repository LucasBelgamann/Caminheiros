<template>
  ...
  <div class="form-login">
    <q-input class="in-register" :class="mode ? 'default-input-color-dark' : 'default-input-color-ligth'" clearable filled
      color="primary" v-model="nome" label="Nome" />
    <q-input class="in-register" :class="mode ? 'default-input-color-dark' : 'default-input-color-ligth'" clearable filled
      color="primary" v-model="telefone" label="Telefone" />
    <q-input class="in-register" :class="mode ? 'default-input-color-dark' : 'default-input-color-ligth'" clearable filled
      color="primary" v-model="email" label="E-mail" />
    ...
    <q-select filled v-model="typeUser" :options="options" v-if="role === 'manager'" label="Tipo do usuário"
      class="in-register" :class="mode ? 'default-input-color-dark' : 'default-input-color-ligth'" />
